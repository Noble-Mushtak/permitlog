...
/// Content for the about page, takes advantage of [flutter_markdown].
const String _aboutText = "# What is this app?\n"
    "The Permit Log mobile app helps teen drivers with learner's permits "
    "accurately and easily record their driving hours. It keeps a running total"
    " of the number of hours driven and tracks all of the data required for a "
    "permit log. When the permit-holder completes all of their required hours, "
    "they can export them, either in a generic spreadsheet format or using the "
    "Maine-specific form, then print it out and send it to the DMV. Watch our "
    "[video presentation](https://youtu.be/Rr6QkbFO8R8) to learn more.\n"
